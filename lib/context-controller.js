...
export class ContextProvider {
  ...
  #host; /** @type {import("../types").UIElement}  UIElement instance of host element */
  #hostPrototype; /** @type {import("../types").UIElement} UIElement instance protoype */
...
export class ContextConsumer {
  ...
  #host; /** @type {import("../types").UIElement}  UIElement instance */
  #hostPrototype; /** @type {import("../types").UIElement} UIElement instance prototype */
    ...
    requestAnimationFrame(() => {
      this.#hostPrototype.observedContexts?.forEach((/** @type {PropertyKey} */ context) => {
        const callback = (/** @type {{ (): any; set?: (value: any) => any; }} */ value, /** @type {() => void} */ unsubscribe) => {
          ...
          const input = this.#hostPrototype.contextMap[context];

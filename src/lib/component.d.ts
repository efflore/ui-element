...
declare const component: (tag: string, attributeMap: UIAttributeMap, connect: (host: UIElement, my: UIRef) => void, disconnect: (host: UIElement) => void) => {
    new (): {
        ...
        set<V>(key: PropertyKey, value: V | ((old: V) => V) | import("../cause-effect").UIState<V>, update?: boolean): void;
        ...
        targets(key: PropertyKey): Set<Element>;
        "__#1@#states": Map<PropertyKey, import("../cause-effect").UIState<unknown>>;
        accessKey: string;
